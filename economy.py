...
class EconomicAnalyzer:
    ...
    def calculate_roi(
        ...
        # Simülasyon periyodu sistem ömrünü kapsıyorsa orantılı hesapla
        if years >= self.system_lifespan_years:
            total_savings = savings["cost_saved"] * (self.system_lifespan_years / years)
            annual_savings = total_savings / self.system_lifespan_years
        else:
            # Simülasyon süresi sistem ömründen kısaysa extrapolate et
